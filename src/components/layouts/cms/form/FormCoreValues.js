...
export function FormCoreValues({ title = "Core Values", initialData = {}, action }) {
...
export function FormDatatableCoreValues({ title = "Core Values", initialData = {}, action }) {
    const [errors, setErrors] = useState({});
    const [formData, setFormData] = useState({
        title: initialData?.title || "",
